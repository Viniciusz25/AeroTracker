...
class TrackerView(QWidget):
    ...
    def __init__(self, model: TrackerModel, parent=None) -> None:
        ...
        l_c1_title.setStyleSheet(f"color: {Theme.Colors.TEXT_MUTED}; border: none;")
        ...
        self.input_flight.setFixedWidth(140)
        ...
        form_row.addWidget(self.btn_refresh)
        ...
        l_c2_title.setStyleSheet(f"color: {Theme.Colors.TEXT_MUTED}; border: none;")
        c2.main_layout.addWidget(l_c2_title)

        sched_row = QHBoxLayout()

        icon_plane = QLabel("✈")
        icon_plane.setFont(Theme.Fonts.card_title())
        icon_plane.setStyleSheet(f"color: {Theme.Colors.PRIMARY}; background-color: {Theme.Colors.POSITIVE_BG}; border-radius: 12px; padding: 4px 8px; border: none;")
        ...
        btn_del = QLabel("🗑")
        btn_del.setFont(Theme.Fonts.card_title())
        btn_del.setStyleSheet(f"color: {Theme.Colors.TEXT_MUTED}; border: none; padding: 4px;")
        sched_row.addWidget(btn_del)
        ...
        l_center_plane.setStyleSheet(f"color: {Theme.Colors.PRIMARY}; border: none;")
        ...
        line.setStyleSheet(f"background-color: {Theme.Colors.BORDER}; min-height: 2px; border: none;")
        ...
        l_m1_tag.setStyleSheet(f"color: {Theme.Colors.TEXT_MUTED}; border: none;")
        ...
        l_m2_tag.setStyleSheet(f"color: {Theme.Colors.TEXT_MUTED}; border: none;")
        ...
        l_m3_tag.setStyleSheet(f"color: {Theme.Colors.TEXT_MUTED}; border: none;")
        ...
        l_c3_sub.setStyleSheet(f"color: {Theme.Colors.TEXT_MUTED}; border: none;")
